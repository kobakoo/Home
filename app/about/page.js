        ...
        <div className="mx-auto flex w-3/4">
          <div className="align-center m-auto justify-center">
            ...
            <p className="mr-5 font-sans text-sm md:text-base">
              こんにちは。コバコ(kobako)です。どっかの化粧ブランドのパクリではありません。はじめましての方は初めましてですね。私についての説明を箇条書きにします。私はまだまだ勉強中ではありますがプログラミングを勉強しています。JSやDBにも最近(2023/11)は手を付けてみてます。最近Firebaseがかなり使えるようになってきました。また、こんな感じのウェブデザインを行うことができます。Apple大好きのApple信者です。さあ、皆さんもApple信者になりましょう!(布教)
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="mx-auto grid h-full w-auto max-w-full grid-cols-1 gap-4 lg:grid-cols-2">
        ...
        <div className="mx-auto flex w-3/4">
          <div className="align-center m-auto justify-center">
            ...
            <p className="mr-5 font-sans text-sm leading-tight md:text-base">
              趣味についてですね。私には実はいろんな趣味があったりします。最近は本を読んだり、それこそプログラミングをしています。最近読んだ本は
              <Link
                href="https://amzn.to/3JNQZ90"
                target="_blank"
                className="text-cyan-500"
              >
                「人を動かす」
              </Link>
              ですね。死ぬ前に一回は読め(命令)。他に習い事としては水泳をやっていました。小６までやってましたね。クロールで50mは27秒,25mは14秒ぐらいで泳げるぐらいでした。結構速いですね()
